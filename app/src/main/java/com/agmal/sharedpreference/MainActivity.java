...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        if (com.agmal.sharedpreference.Preferences.getLoggedInStatus(getBaseContext())) {
    ...
    private void validasiLogin() {
        ...
        if (cancel) {
            ...
            com.agmal.sharedpreference.Preferences.setUserPreferences(getBaseContext(), userModel);
            com.agmal.sharedpreference.Preferences.setLoggedInStatus(getBaseContext(), true);
    ...
    private boolean cekUser(String user) {
        return user.equals(com.agmal.sharedpreference.Preferences.getRegisteredUser(getBaseContext()));
    }
